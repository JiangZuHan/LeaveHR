(function (a) {
    ...
    var i = function (l, k) {
        ...
        //增加可以請假的特定日期陣列(補班專用)
        this.enabledDates = k.enabledDates || [];
    ...
    i.prototype = {
        ...
        fill: function () {
            ...
            while (K.valueOf() < j) {
                ...
                //    v += " disabled"
                //}
                if ((K.valueOf() + 86400000) <= this.startDate || K.valueOf() > this.endDate || (f.inArray(K.getUTCDay(), this.daysOfWeekDisabled) !== -1 && $.inArray(K.Format('yyyy/MM/dd'), this.enabledDates) === -1) || f.inArray(K.toDateString(), this.datesDisabled) !== -1) {
                    v += " disabled"
                }
