<%@ Page Title="" Language="C#" MasterPageFile="~/請假主版.Master" AutoEventWireup="true" CodeBehind="select2.aspx.cs" Inherits="全傳請假系統.select2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $.ajax({
                url: '/Tools/select.ashx?mode=Dept',
                type: 'POST',
            ...
            $.ajax({
                url: '/Tools/select.ashx?mode=User',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                cache: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                ...
                <select id="Approval" class="form-control" style="width: 160px">
                    ...
                    <option value="2">課長或副理核准</option>
                    <option value="3">最高級主管核准</option>
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group form-inline">
                                ...
                                <div class="input-group col-md-12" style="margin-top: 10px; display: block">
                                    <div class="input-group">
                                    ...
                                    <div class="input-group col-xs-12 col-sm-1 col-lg-1 col-md-1 text-right">
                                        <input id="hr2" type="text" class="form-control w70" style="width: 57px;" value="" name="hr" />
                                    </div>
                                </div>
    ...
    <script>
        ...
        (function GetSupervisor(){
            $.ajax({
                type: 'POST',
                url: 'Tools/select.ashx?mode=CanAdvanceMode',
                async:false,
                success: function (data2) {
        ...
        $.ajax({
            type: 'POST',
            url: 'Tools/leftleave.ashx?mode=nine',
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success: (function (nine) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'Tools/leftleave.ashx?mode=ninehr',
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
                    success: (function (ninehr) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'Tools/leftleave.ashx?mode=two',
                            dataType: 'json',
                            contentType: 'application/json; charset=utf-8',
        ...
        $('#Dept').change(function () {
            ...
            $('#UserTable').bootstrapTable('refresh', {
                cache: false,
                contentType: 'application/json; charset=utf-8',
                url: '/Tools/select.ashx?mode=User&dept=' + encodeURI(dept) + '&a=' + Math.random(),
                type: 'POST',
                async: true,
        ...
        $('#Update').click(function () {
            ...
            $('#Leaveid2').change(function () {
                ...
                $.ajax({//使用者點下修改假單Show的
                    type: 'POST',
                    url: 'Tools/leftleave.ashx?mode=' + id,
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
        ...
        $('#Delete').click(function () {
            ...
            $('#Remove').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    async:false,
                    url: 'Tools/leaveuser.ashx?pass=HRdelete&deletebtn=' + deletebtn + '&pa60002=' + pa60002 + '&id=' + id + '&from=' + from + '&to=' + to + '&hr=' + hr + '&cause=' + encodeURI(cause) + '&name=' + name + '&pa39=' + encodeURI(pa39) + '&nopass=' +encodeURI(nopasstext) ,
                    success:(function (data) {
                        location.href = 'select2.aspx';
                    })
                });
            });
        });
        $('#removebtn').click(function(){
            ...
            $.ajax({
                type: 'POST',
                async:false,
                url: 'Tools/leaveuser.ashx?pass=HRdelete_2&id=' + id + '&user=' + user+'&TYP='+TYP ,
                success:(function (data) {
                    if(data!=''){
                        alert(data);
        ...
        $('#Search').click(function () {
            ...
            var url1 = '/Tools/select.ashx?mode=Search';
        ...
        $('#Clear').click(function () {
            ...
            $('#UserTable').bootstrapTable('refresh', {
                cache: false,
                contentType: 'application/json; charset=utf-8',
                url: '/Tools/select.ashx?mode=User&dept=' + dept + '&a=' + Math.random(),
                type: 'POST',
                async: true,
                queryParams: { dept: JSON.stringify(dept) },
                dataType: 'json'
        ...
        $('#update').click(function () {
            ...
            if (id2 == 0 || from2 == "" || to2 == "" || cause2 == "") {
                ...
                $.ajax({
                    async: false,
                    url: 'Tools/leaveuser.ashx?pass=HRupdate&user=' + user + '&water=' + water + '&id2=' + id2 + '&from2=' + from2 + '&to2=' + to2 + '&hr2=' + hr2 + '&cause2=' + encodeURI(cause2) + '&pa39=' + pa39 + '&updeath=' + updeath + '&death=' + death + '&CoDpath=' + CoDpath,
                    type: 'POST',
                    dataType: 'json',   
                    contentType: 'application/json; charset=utf-8'
        ...
        function upload2(data, id2, user) {
            ...
            $.ajax({
                type: "post",
                url: "Tools/leaveuser.ashx?pass=HRupload&id=" + id2 + "&user=" + user,
                contentType: "application/json; charset=utf-8",
                data: data,
                async: false,
                contentType: false,
