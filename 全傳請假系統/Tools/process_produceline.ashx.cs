...
namespace 全傳請假系統.Tools
{
    ...
    /// process 的摘要描述
    /// </summary>
    public class process_produceline : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        private DataTable queryDataTable1()
        {
            ...
            sql1 = "select PA60039, PA60041, PA60003 ,PA60043,PA60011, PA60999, PA60998 from [TBI_HRS].[dbo].[PA123] where PA60996 = '" + username + "' and PA60003 = '" + water + "' ";
        ...
        {
            var WorkHoliday = GetWorkHoliday(context);

            var Vacation = GetVacation(context);
